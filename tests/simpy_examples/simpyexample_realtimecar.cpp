...
namespace {
class SimPyExampleRealTimeCarTests : public TestBase
{};
...
TEST_F(SimPyExampleRealTimeCarTests, exampleCar1_realTimeInTwoTenthsSeconds_worksAsExpected)
{
  ...
  //RealTimeSimulation simRT(ConstructionData()
  //                             .setParameter<RealTimeSimulation::Resolution_s>(resolution)
